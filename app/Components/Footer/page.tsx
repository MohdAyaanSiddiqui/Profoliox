            ...
            <footer className="footer-root flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-[#0C0414] border-t border-white/10">
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            ...
                            <li><a href="/" className="hover:text-indigo-400 transition">Affiliate</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            <li><a href="/" className="hover:text-indigo-400 transition">Company</a></li>
                            <li><a href="/" className="hover:text-indigo-400 transition">Blogs</a></li>
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    ...
                    <div className="flex items-center gap-4 mt-3">
                        {/* Dribbble */}
                        <a href="https://dribbble.com/prebuiltui" target="_blank" rel="noreferrer" aria-label="Dribbble">
                        ...
                        {/* LinkedIn */}
                        <a href="https://www.linkedin.com/company/prebuiltui" target="_blank" rel="noreferrer" aria-label="LinkedIn">
                        ...
                        {/* Twitter / X */}
                        <a href="https://x.com/prebuiltui" target="_blank" rel="noreferrer" aria-label="Twitter">
