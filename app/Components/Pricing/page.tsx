                ...
                <div className="flex flex-col md:flex-row gap-6 max-w-6xl w-full justify-center">
                    ...
                    <div className="bg-white border border-zinc-200 rounded-3xl px-8 pt-8 pb-6 w-full md:w-[360px] flex flex-col">
                        ...
                        <div className="mb-4.5">
                            <h2 className="text-4xl font-medium text-zinc-800">
                                ...
                                <span className="text-base font-medium text-zinc-500">{starterAnnual ? '/year' : '/month'}</span>
                            </h2>
                        </div>
                                    ...
                                    <li key={index} className="flex items-center gap-3">
                                        <div className="w-4.5 h-4.5 rounded-sm bg-rose-500 flex items-center justify-center shrink-0">
                                            <svg width="9" height="6" viewBox="0 0 9 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="m7.75.75-4.812 4L.75 2.932" fill="#ff2056" /><path d="m7.75.75-4.812 4L.75 2.932" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                        </div>
                        ...
                        <div className="flex items-center justify-between mb-3.5">
                            ...
                            <button onClick={() => setStarterAnnual(!starterAnnual)} className={`w-11 h-6 rounded-full cursor-pointer transition-colors duration-200 relative ${starterAnnual ? 'bg-rose-500' : 'bg-zinc-100'}`}>
                                <div className={`absolute top-1 left-1 w-4 h-4 bg-rose-500 rounded-full transition-transform duration-300 ${starterAnnual ? 'translate-x-5 bg-white' : 'translate-x-0'}`} />
                            </button>
                        </div>
                    ...
                    <div className="bg-zinc-900 border border-zinc-200 rounded-3xl px-8 pt-8 pb-6 w-full md:w-[360px] flex flex-col">
                        ...
                        <div className="mb-6 flex items-center justify-between gap-3">
                            ...
                            <span className="inline-block px-4 py-1.5 bg-rose-500/10 border border-rose-600 rounded-full text-xs text-rose-500">
                                Most Popular
                            </span>
                        </div>
                        ...
                        <div className="mb-4.5">
                            <h2 className="text-4xl font-medium text-white">
                                ...
                                <span className="text-base font-medium text-white">{scaleAnnual ? '/year' : '/month'}</span>
                            </h2>
                        </div>
