...
export default function Example() {
    return (
        <>
            ...
            `}</style>
            <div className="max-w-5xl mt-90 py-16 md:pl-20 md:w-full mx-2 md:mx-auto p-4 flex flex-col md:flex-row items-center justify-between text-left rounded-2xl md:p-10 text-white bg-white/5 backdrop-blur-md border border-white/10 shadow-2xl">
                <div>
                    <div>
                        <p className="text-slate-200">Trusted by 10k+ developers</p>
